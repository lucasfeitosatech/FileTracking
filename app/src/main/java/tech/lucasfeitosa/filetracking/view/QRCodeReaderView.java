package tech.lucasfeitosa.filetracking.view;
...
import com.google.zxing.binaryqrcode.binary.BinaryQRCodeReader;
...
public class QRCodeReaderView extends SurfaceView
    ...
    public interface OnQRCodeReadListener {
        ...
        void onQRCodeRead(String text, byte[] rawData, PointF[] points);
    }
    ...
    private static class DecodeFrameTask extends AsyncTask<byte[], Void, Result> {
        ...
        @Override protected Result doInBackground(byte[]... params) {
            ...
            view.bReader = new BinaryQRCodeReader();
            try {
                //return view.mQRCodeReader.decode(bitmap, hintsRef.get());
                return view.bReader.decode(bitmap);
        ...
        @Override protected void onPostExecute(Result result) {
            ...
            if (view != null && result != null && view.mOnQRCodeReadListener != null) {
                ...
                view.mOnQRCodeReadListener.onQRCodeRead(result.getText(), result.getRawBytes(), transformedPoints);
            }
        }
